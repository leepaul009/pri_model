...
if param_load and os.path.exists(cls_dist_f):
  ...
  map_cls_to_mid = cls_dist_npz_data['mat_cls_dist'].item()
  map_mid_to_cls = cls_dist_npz_data['mat_cls_dist'].item()
...
def splitData(cand_cls, df, mDistAll, cls2id, id2cls, cls2size, cls2expIds):
  ...
  n_test = np.ceil(whole_sz * 0.4)
  n_train = np.ceil(whole_sz * 0.4)
...
ddna_test_cls_expIds = splitData(candidate_cls, map_naType2df['dsDNA'], mDist_cls, 
  map_cls_to_mid, map_mid_to_cls, 
  map_cls2uniqSize, map_cls2uniqExpIds)

drna_test_cls_expIds = splitData(candidate_cls, map_naType2df['dsRNA'], mDist_cls, 
  map_cls_to_mid, map_mid_to_cls, 
  map_cls2uniqSize, map_cls2uniqExpIds)

sdna_test_cls_expIds = splitData(candidate_cls, map_naType2df['ssDNA'], mDist_cls, 
  map_cls_to_mid, map_mid_to_cls, 
  map_cls2uniqSize, map_cls2uniqExpIds)

srna_test_cls_expIds = splitData(candidate_cls, map_naType2df['ssRNA'], mDist_cls, 
  map_cls_to_mid, map_mid_to_cls, 
  map_cls2uniqSize, map_cls2uniqExpIds)
